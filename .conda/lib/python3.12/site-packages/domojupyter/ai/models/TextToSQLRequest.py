...
class TextToSQLRequest:
    def __init__(self, input_str: str,
                 data_source_schemas: Optional[list[DataSourceSchema]],
    ...
    def to_json(self):
        return {
            "input": self.input,
            "dataSourceSchemas": [schema.to_json() for schema in self.dataSourceSchemas] if self.dataSourceSchemas is not None else None,
